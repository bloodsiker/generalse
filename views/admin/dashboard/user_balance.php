    ...
    <div class="row" style="margin-top: 20px">
        <div class="column medium-4">
            ...
            <table class="dashboard-section" border="1" cellspacing="0" cellpadding="5">
                ...
                <tbody>
                <tr>
                    <td class="price" colspan="2"><?= Umbrella\models\Balance::getBalanceByPartner($id_user)?>$</td>
                </tr>
                <tr>
                    <td>
                                    ...
                                    <?php if(is_array($listInterval)):?>
                                        <?php foreach ($listInterval as $interval):?>
                                            ...
                                            <option <?=(isset($_GET['interval']) && $_GET['interval'] == $year_month) ? 'selected' : ''?> value="<?=$year_month?>">
                                                <?=$interval['year'] . ' ' . $interval['month_name']?> || <?= Umbrella\models\Balance::getBalanceMonthByPartner($id_user, $year_month)?>$
                                            </option>
                                        <?php endforeach;?>
                                    <?php endif;?>
                                </select>
