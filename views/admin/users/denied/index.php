                                ...
                                <tr style="<?= ($page['id'] == $p_id) ? 'background: #66bb6a' : ''?>">
                                    ...
                                    <td>
                                        <form action="" method="POST">
                                            ...
                                            <?php if(!in_array($page['name'], $new_array)):?>
                                    ...
                                    <td>
                                        <?php if($page['sub_menu'] == 1):?>
                                            <a href="/adm/user/denied/<?=$id_user?>/<?= $page['id']?>" class="button no-margin small"><i class="fi-list"></i></a>
                                        <?php endif;?>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            ...
                            <tr style="<?= ($sub['id'] == $sub_id) ? 'background: #66bb6a' : ''?>">
                                ...
                                <td>
                                    <form action="" method="POST">
                                        ...
                                        <?php if(!in_array($sub['name'], $new_array)):?>
                                            <input type="hidden" name="action" value="denied">
                                            <input type="submit" class="alert button tiny expanded" value="Denied">
                                        <?php else:?>
                                            <input type="hidden" name="action" value="success">
                                ...
                                <td>
                                    <?php if($sub['sub_menu'] == 2):?>
                                        <a href="/adm/user/denied/<?=$id_user?>/<?= $sub['p_id']?>/<?= $sub['id']?>" class="button no-margin small"><i class="fi-list"></i></a>
                                    <?php endif;?>
                                </td>
                            </tr>
                        <?php endforeach;?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="" method="POST">
                                            ...
                                            <?php if(!in_array($button['name'], $new_array)):?>
                                                <input type="hidden" name="action" value="denied">
                                                <input type="submit" class="alert button tiny expanded" value="Denied">
                                            <?php else:?>
                                                <input type="hidden" name="action" value="success">
