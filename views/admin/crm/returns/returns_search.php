                ...
                <table class="umbrella-table">
                    <caption>
                        ...
                        <span id="count_refund" class="text-green">
                            (<?php if (isset($allReturnsByPartner)) echo count($allReturnsByPartner) ?>)
                        </span>
                    </caption>
                    <thead>
                    <tr>
                        ...
                        <?php if (is_array($allReturnsByPartner)): ?>
                            <?php foreach ($allReturnsByPartner as $return): ?>
                                <tr data-return="<?=$return['stock_return_id']?>" class="goods">
                                    <td><?= \Umbrella\components\Functions::replaceSearchResultUtf($search, $return['stock_return_id'])?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResultUtf($search, $return['site_client_name'])?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResultUtf($search, $return['order_number'])?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResultUtf($search,  $return['so_number'])?></td>
                                    ...
                                    <td><?= \Umbrella\components\Functions::replaceSearchResultUtf($search, $return['part_number'])?></td>
                                    <td><?= $return['order_type']?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResultUtf($search,  $return['goods_name'])?></td>
