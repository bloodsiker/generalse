                        ...
                        <?php if (is_array($allReturnsByPartner)): ?>
                            <?php foreach ($allReturnsByPartner as $return): ?>
                                <tr data-return="<?=$return['stock_return_id']?>" class="goods">
                                    <td><?= \Umbrella\components\Functions::replaceSearchResult($search, $return['stock_return_id'])?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResult($search, $return['site_client_name'])?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResult($search, $return['order_number'])?></td>
                                    <td><?= \Umbrella\components\Functions::replaceSearchResult($search,  $return['so_number'])?></td>
