            ...
            <div class="row body-content" style="background: #EFEFEF">
                <div class="medium-12 small-12 columns">
                    <form method="post" class="form" data-abide novalidate enctype="multipart/form-data">
                        ...
                        <div class="tabs-content" style="background: #efefef; border: 1px solid #323e48;" data-tabs-content="collapsing-tabs">
                            <div class="tabs-panel is-active" id="panel1c">
                                <div class="row">
                                    <div class="large-12 columns">
                                        <label>Title
                                            <input type="text" name="en_title" class="required" value="<?= $new['en_title'] ?>" required/>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        <label>Description
                                            <input type="text" name="en_description" class="required" value="<?= $new['en_description'] ?>" required/>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        <label>Article
                                            <textarea name="en_text" id="ck_article" cols="30" rows="4"><?= $new['en_text'] ?></textarea>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tabs-panel" id="panel2c">
                                <div class="row">
                                    <div class="large-12 columns">
                                        <label>Тема
                                            <input type="text" name="ru_title" class="required" value="<?= $new['ru_title'] ?>" required/>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        <label>Краткое описание
                                            <input type="text" name="ru_description" class="required" value="<?= $new['ru_description'] ?>" required/>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        <label>Статья
                                            <textarea name="ru_text" id="edit" cols="30" rows="4"><?= $new['ru_text'] ?></textarea>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="large-12 columns">
                                <img src="<?= $new['image'] ?>" width="300px" alt="">
                            </div>
                        </div>
                            ...
                            <div class="large-12 columns">
                                <label>Published
                                    <select name="published" class="required" required>
                                        <option value="1" <?= $new['published'] == 1 ? 'selected' : null ?>>Yes</option>
                                        <option value="0" <?= $new['published'] == 0 ? 'selected' : null ?>>No</option>
                                    </select>
                                </label>
                            </div>
                        </div>

                        <input type="hidden" name="edit_new" value="true">
