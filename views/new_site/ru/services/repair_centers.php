...
<div class="main">
    ...
    <main class="container">
        ...
        <div class="services-head" style="background-image: url('http://generalse.com/template/site/img/About/3TJ6NCTIRT.jpg');">
            <div class="container">
                <h1>Service for repair Centers</h1>
                <h4>Buy and sell with General Services</h4>
                <div class="row mt-5 justify-content-center">
                    ...
                    <div class="col-md-4 mb-3">
                        <div data-scroll data-scroll-link="section-2" class="services-head-link">
                            ...
                            <div>
                                Sell your overstock and defective assets
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section data-scroll-div="section-1" class="container">
            <div class="row ">
                ...
                <div class="col-md-6">
                    <h2 class="text-uppercase mb-5">Buy original parts</h2>
        ...
        <section data-scroll-div="section-2" class="container">
            <div class="row ">
                ...
                <div class="col-md-6">
                    <h2 class="text-uppercase mb-5">Sell your overstock and defective assets</h2>
