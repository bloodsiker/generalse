    ...
    <main class="container">
        ...
        <div class="row pt-5 mb-lg-5">
            <div class="col-md-6">
                ...
                <p>Если ваша компания является производителем или поставщиком одной из указанных товарных групп, заполните запрос в Форме Поставщика на данной станице, и мы свяжемся с Вами.</p>
            </div>
            <div class="col-md-6">
